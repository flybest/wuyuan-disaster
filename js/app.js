(function($, owner) {
	var BASE_URL='http://192.168.25.104/wuyuan-disaster/';
	...
	owner.getnoticelist_url=BASE_URL+'server/getnoticelist.php';
	owner.getnoticedetail_url=BASE_URL+'server/getnoticedetail.php';
	owner.savenoticedetail_url=BASE_URL+'server/getnoticedetail.php';
	owner.getalertlist_url=BASE_URL+'server/getalertlist.php';
	owner.getalertdetail_url=BASE_URL+'server/getalertdetail.php';
	owner.savealertdetail_url=BASE_URL+'server/getalertdetail.php';

	owner.filedownload_url='';
	owner.fileupload_url='';
	owner.locationupload_url='';
